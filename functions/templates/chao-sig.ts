export const chaoSignature = `
<a href="https://usechao.com">
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=M+PLUS+Rounded+1c:wght@100;300;400;500;700;800;900&display=swap" rel="stylesheet" />
  <div style="font-family: 'M PLUS Rounded 1c', sans-serif;">
    <div style="display: flex; align-items: center;">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg); width: 25px; height: 25px; margin-right: 10px;" preserveAspectRatio="xMidYMid meet" viewBox="0 0 36 36">
      ...
      <p style="color: rgb(244, 63, 94); font-size: 20px; font-weight: 900;">CHÁO</p>
      </div>
    </div>
  </div>
</a>
