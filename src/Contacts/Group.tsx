  ...
  return (
    <div className="">
        {groupLoading ? 
          ...
          <p className={`font-black text-3xl text-yellow-500 pb-6`}>{groupData?.fields.name || ''}</p>
        }
        <div className="w-full flex space-x-4">
          ...
          <div className="relative">
            <div onClick={() => setAddNewContact(true)} className="px-4 py-2 cursor-pointer shadow-md hover:shadow-lg transform transition-transform duration-150 ease-in-out hover:-translate-y-1 bg-yellow-500 text-white flex items-center justify-center font-semibold rounded-md">
              New Contact
            </div>
            {
          ...
          <div className="px-4 py-2 cursor-pointer shadow-md hover:shadow-lg transform transition-transform duration-150 ease-in-out hover:-translate-y-1 bg-yellow-500 text-white flex items-center justify-center font-semibold rounded-md">
            Import Contacts
          </div>
        </div>
        {isLoading ? 
          <div className="w-full py-24 flex items-center justify-center">
            <svg className="animate-spin text-yellow-700 w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div>
          {!hasNextPage && !isLoading ? 
            <div className="py-24 flex items-center justify-center font-black text-xl text-yellow-500"> That's Everyone! </div> : ''}
        </div>
      </div>
  )
}